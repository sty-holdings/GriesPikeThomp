...
const (
	...
	STRIPE_ID_INVALID              = "The stripe payment intent id is invalid. See https://docs.stripe.com/api/payment_intents source."
	STRIPE_KEY_INVALID             = "The stripe key is invalid. See https://docs.stripe.com/api/payment_intents source."
	STRIPE_METHOD_TYPE_EMPTY       = "An empty payment method type is not allowed."
...
var (
	...
	ErrStripeIdInvalid             = errors.New(STRIPE_ID_INVALID)
	ErrStripeKeyInvalid            = errors.New(STRIPE_KEY_INVALID)
	ErrStripeMethodTypeEmpty       = errors.New(STRIPE_METHOD_TYPE_EMPTY)
