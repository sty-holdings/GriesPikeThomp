...
const (
	...
	PID_FILE_EXISTS                = "A SavUp server PID file already exists. Delete the 'server.pid' file in '.run' directory and start the server again."
...
var (
	...
	ErrJSONGenrationFailed        = errors.New(JSON_GENERATION_FAILED)
